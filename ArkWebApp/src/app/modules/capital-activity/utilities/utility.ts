...
export function getUniqueOptions(ref: {capitalTypes: string[], capitalSubTypes: string[], strategies: string[], overrideCurrencies:string[], refData: any}): any {
    ...
    let overrideCurrencies: string[] = getUniqueOptionsFor(ref.overrideCurrencies);
    let fundCcys: string[] = [];
    let posCcys: string[] = [];
    ...
    return {capitalTypes, capitalSubTypes, fundHedgings, issuerShortNames, assets, fundCcys, posCcys,  wsoIssuerIDs, wsoAssetIDs, strategies, overrideCurrencies};
}
