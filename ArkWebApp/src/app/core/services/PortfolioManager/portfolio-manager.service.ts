...
export class PortfolioManagerService {
  ...
  public getPortfolioMapping(){
    ...
    return this.http.get<any>(APIConfig.PORTFOLIO_MAPPING_GET_API).pipe(
  ...
  public getPortfolioMappingStaging(){
    ...
    return this.http.get<any>(APIConfig.PORTFOLIO_MAPPING_STAGING_GET_API).pipe(
      catchError((ex) => throwError(ex))
    )
  }
  ...
  public putPortfolioMapping(model: PortfolioMapping){
    ...
    return this.http.post<any>(APIConfig.PORTFOLIO_MAPPING_PUT_API, model).pipe(
      catchError((ex) => throwError(ex))
    )
  }
  ...
  public putPortfolioMappingApproval(model: PortfolioMappingApproval){
    ...
    return this.http.post<any>(APIConfig.PORTFOLIO_MAPPING_APPROVAL_PUT_API, model).pipe(
      catchError((ex) => throwError(ex))
    )
  }
}
